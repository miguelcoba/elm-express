	...
	function (wid, grid) {
		...
		while (true) {
			...
			if (_p7.ctor === '[]') {
				...
				var lineY = _elm_lang$core$Basics$snd(_p7._0.pos);
				var _p8 = A2(
					_elm_lang$core$List$partition,
					function (_p9) {
						var _p10 = _p9;
						return _elm_lang$core$Native_Utils.eq(
							_elm_lang$core$Basics$snd(_p10.pos),
							lineY);
					},
					grid);
				var inline = _p8._0;
		...
		if (_p11.ctor === 'Nothing') {
			...
			var clearedGrid = A2(
				...
				function (_p12) {
					var _p13 = _p12;
					return !_elm_lang$core$Native_Utils.eq(
						_elm_lang$core$Basics$snd(_p13.pos),
						_p18);
				},
				grid);
			var _p14 = A2(
				...
				function (_p15) {
					var _p16 = _p15;
					return _elm_lang$core$Native_Utils.cmp(
						_elm_lang$core$Basics$snd(_p16.pos),
						_p18) < 0;
				},
				clearedGrid);
			var above = _p14._0;
				...
				function (c) {
					return _elm_lang$core$Native_Utils.update(
						c,
						{
							pos: {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Basics$fst(c.pos),
								_1: _elm_lang$core$Basics$snd(c.pos) + 1
							}
						});
				},
				above);
	...
	function (wid, hei, x, y, sample, grid) {
		...
		while (true) {
			...
			if (_p19.ctor === '[]') {
				...
				var _p20 = {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$fst(_p21.pos) + x,
					_1: _elm_lang$core$Basics$snd(_p21.pos) + y
				};
				var x$ = _p20._0;
				var y$ = _p20._1;
				if ((_elm_lang$core$Native_Utils.cmp(x$, wid) > -1) || ((_elm_lang$core$Native_Utils.cmp(x$, 0) < 0) || ((_elm_lang$core$Native_Utils.cmp(y$, hei) > -1) || A2(
	...
	function (x, y, sample, grid) {
		...
		while (true) {
			...
			if (_p22.ctor === '[]') {
				...
				var newPos = {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$fst(_p25.pos) + x,
					_1: _elm_lang$core$Basics$snd(_p25.pos) + y
				};
		...
		var fn = function (cell) {
			return clockwise ? _elm_lang$core$Native_Utils.update(
				cell,
				{
					pos: {
						ctor: '_Tuple2',
						_0: (1 + y) - _elm_lang$core$Basics$snd(cell.pos),
						_1: ((0 - x) + y) + _elm_lang$core$Basics$fst(cell.pos)
					}
				}) : _elm_lang$core$Native_Utils.update(
				cell,
				{
					pos: {
						ctor: '_Tuple2',
						_0: ((0 - y) + x) + _elm_lang$core$Basics$snd(cell.pos),
						_1: (1 + x) - _elm_lang$core$Basics$fst(cell.pos)
					}
				});
		};
		return A2(_elm_lang$core$List$map, fn, grid);
	});
var _w0rm$elm_flatris$Grid$empty = _elm_lang$core$Native_List.fromArray(
	[]);
...
var _w0rm$elm_flatris$Grid$decode = function (cell) {
	return _elm_lang$core$Json_Decode$list(
		A3(
			...
			A2(_elm_lang$core$Json_Decode_ops[':='], 'val', cell),
			A2(
	...
	return function (_p0) {
		...
		return _elm_lang$core$Json_Encode$list(
			A2(
				...
				_elm_lang$core$Json_Encode$int,
				_elm_lang$core$Native_List.fromArray(
					[_p1.red, _p1.green, _p1.blue])));
	}(
		_elm_lang$core$Color$toRgb(color));
};
var _w0rm$elm_flatris$Model$decodeColor = A4(_elm_lang$core$Json_Decode$tuple3, _elm_lang$core$Color$rgb, _elm_lang$core$Json_Decode$int, _elm_lang$core$Json_Decode$int, _elm_lang$core$Json_Decode$int);
			...
			_elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						'positionX',
						_elm_lang$core$Json_Encode$int(
							_elm_lang$core$Basics$fst(model.position))),
						A2(
						_w0rm$elm_flatris$Model_ops['=>'],
						'positionY',
						_elm_lang$core$Json_Encode$float(
							_elm_lang$core$Basics$snd(model.position))),
						A2(
						_w0rm$elm_flatris$Model_ops['=>'],
						'grid',
			...
			model,
			{
				...
				position: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$Json_Decode$decodeString,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'positionX', _elm_lang$core$Json_Decode$int),
							string)),
					_1: A2(
						_elm_lang$core$Result$withDefault,
						_elm_lang$core$Basics$snd(model.position),
						A2(
							_elm_lang$core$Json_Decode$decodeString,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'positionY', _elm_lang$core$Json_Decode$float),
							string))
				},
				grid: A2(
					_elm_lang$core$Result$withDefault,
				...
				lines: A2(
					...
					A2(
						_elm_lang$core$Json_Decode$decodeString,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'lines', _elm_lang$core$Json_Decode$int),
						string)),
				next: A2(
					_elm_lang$core$Result$withDefault,
					model.next,
...
var _w0rm$elm_flatris$Update$rotateTetrimino$ = function (model) {
...
var _w0rm$elm_flatris$Update$activateButton = F3(
	function (interval, elapsed, state) {
		...
		return (_elm_lang$core$Native_Utils.cmp(elapsed$, interval) > 0) ? _elm_lang$core$Native_Utils.update(
			state,
			{active: true, elapsed: elapsed$ - interval}) : _elm_lang$core$Native_Utils.update(
			state,
			{active: false, elapsed: elapsed$});
	});
var _w0rm$elm_flatris$Update$rotateTetrimino = F2(
	function (elapsed, model) {
		...
		if (_p8.ctor === 'Just') {
			var _p9 = _p8._0;
			return (_p9.active ? _w0rm$elm_flatris$Update$rotateTetrimino$ : _elm_lang$core$Basics$identity)(
				_elm_lang$core$Native_Utils.update(
					model,
					{
...
var _w0rm$elm_flatris$Update$moveTetrimino = F2(
	function (elapsed, model) {
		...
		if (_p14.ctor === 'Just') {
			var _p15 = _p14._0;
			return (_p15.active ? _w0rm$elm_flatris$Update$moveTetrimino$(
...
var _w0rm$elm_flatris$Update$getFromStorage = A3(
	_elm_lang$core$Task$perform,
	_elm_lang$core$Basics$always(
		_w0rm$elm_flatris$Actions$Load('')),
	function (v) {
...
var _w0rm$elm_flatris$Update$update = F2(
	function (action, model) {
		...
		switch (_p22.ctor) {
			case 'Init':
				var _p23 = _w0rm$elm_flatris$Tetriminos$random(
			...
			case 'Load':
				return {
					ctor: '_Tuple2',
					_0: A2(_w0rm$elm_flatris$Model$decode, _p22._0, model),
			...
			case 'Start':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _w0rm$elm_flatris$Model$Playing, lines: 0, score: 0, grid: _w0rm$elm_flatris$Grid$empty}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Pause':
				return _w0rm$elm_flatris$Update$saveToStorage(
					_elm_lang$core$Native_Utils.update(
						model,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '40px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '60px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '30px 0 0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#bdc3c7'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-weight', '300'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '30px 0 0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#3993d0'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '30px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '5px 0 0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'background', '#34495f'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'border', '0'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'bottom', '30px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#fff'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'cursor', 'pointer'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'display', 'block'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '18px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-weight', '300'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '60px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '30px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '60px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'outline', 'none'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '0'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '120px')
					])),
...
var _w0rm$elm_flatris$View$renderPanel = function (_p12) {
	var _p13 = _p12;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'bottom', '80px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '14px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '300px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '0 30px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'right', '0'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'top', '0')
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_w0rm$elm_flatris$View$renderTitle('Flatris'),
				_w0rm$elm_flatris$View$renderLabel('Score'),
				_w0rm$elm_flatris$View$renderCount(_p13.score),
				_w0rm$elm_flatris$View$renderLabel('Lines Cleared'),
				_w0rm$elm_flatris$View$renderCount(_p13.lines),
				_w0rm$elm_flatris$View$renderLabel('Next Shape'),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_w0rm$elm_flatris$View_ops['=>'], 'margin-top', '10px'),
								A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'relative')
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_w0rm$elm_flatris$View$renderNext(_p13.next)
					])),
				_w0rm$elm_flatris$View$renderGameButton(_p13.state)
			]));
};
		...
		return A2(
			...
			A2(
				...
				_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_w0rm$elm_flatris$View_ops['=>'], 'background', '#ecf0f1'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'border', '0'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'cursor', 'pointer'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'text-align', 'center'),
							A2(_w0rm$elm_flatris$View_ops['=>'], '-webkit-user-select', 'none'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'display', 'block'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'float', 'left'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '24px'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'font-weight', '300'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '60px'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '60px'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', '20px 20px 0 0'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'outline', 'none'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '0'),
							A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '60px')
						])),
				attrs),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _w0rm$elm_flatris$View$renderControls = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '80px'),
					A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '0'),
					A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
					A2(_w0rm$elm_flatris$View_ops['=>'], 'top', '600px')
				]))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_w0rm$elm_flatris$View$onTouchStart(
					_w0rm$elm_flatris$Actions$Rotate(true)),
					_w0rm$elm_flatris$View$onTouchEnd(
					_w0rm$elm_flatris$Actions$Rotate(false))
				])),
			A2(
			_w0rm$elm_flatris$View$renderControlButton,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'background', 'rgba(236, 240, 241, 0.85)'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'color', '#34495f'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-family', 'Helvetica, Arial, sans-serif'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'font-size', '18px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '600px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'left', '0'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'line-height', '1.5'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '0 15px'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'absolute'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'top', '0'),
						A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '270px'),
						A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '30px 0')
					])),
				_w0rm$elm_flatris$View$onTouchEnd(_w0rm$elm_flatris$Actions$UnlockButtons),
				_elm_lang$html$Html_Events$onMouseUp(_w0rm$elm_flatris$Actions$UnlockButtons)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_w0rm$elm_flatris$View_ops['=>'], 'height', '680px'),
								A2(_w0rm$elm_flatris$View_ops['=>'], 'margin', 'auto'),
								A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'relative'),
								A2(_w0rm$elm_flatris$View_ops['=>'], 'width', '480px')
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_w0rm$elm_flatris$View$renderWell(model),
						_w0rm$elm_flatris$View$renderControls,
						_w0rm$elm_flatris$View$renderPanel(model),
						_w0rm$elm_flatris$View$renderInfo(model.state)
					]))
			]));
};
...
var _w0rm$elm_flatris$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_Utils.eq(model.state, _w0rm$elm_flatris$Model$Playing) ? _elm_lang$animation_frame$AnimationFrame$diffs(_w0rm$elm_flatris$Actions$Tick) : _elm_lang$core$Platform_Sub$none,
...
var _w0rm$elm_flatris$Main$main = {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _w0rm$elm_flatris$Main$main === 'undefined' ? null : _w0rm$elm_flatris$Main$main);
